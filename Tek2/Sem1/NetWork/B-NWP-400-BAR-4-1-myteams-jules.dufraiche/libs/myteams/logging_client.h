...
** the team, that have the channel, that have the thread, that got new reply
*/
...
/**
** @brief Must be called when the current logged user receives a private msg
...
** ex: asking the teams are subscribed to or the available teams in a domain
